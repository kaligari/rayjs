 ...
 */
var bo=Object.defineProperty;var Zu=Object.getOwnPropertyDescriptor;var Md=Object.getOwnPropertyNames;var Ud=Object.prototype.hasOwnProperty;var Io=(t,n)=>{for(var e in n)bo(t,e,{get:n[e],enumerable:!0})},Qu=(t,n,e,r)=>{if(n&&typeof n=="object"||typeof n=="function")for(let i of Md(n))!Ud.call(t,i)&&i!==e&&bo(t,i,{get:()=>n[i],enumerable:!(r=Zu(n,i))||r.enumerable});return t},vo=(t,n,e)=>(Qu(t,n,"default"),e&&Qu(e,n,"default"));var ju=(t,n,e,r)=>{for(var i=r>1?void 0:r?Zu(n,e):n,s=t.length-1,a;s>=0;s--)(a=t[s])&&(i=(r?a(n,e,i):a(i))||i);return r&&i&&bo(n,e,i),i};var Ku={};Io(Ku,{ASTBuilder:()=>es,ArrayLiteralExpression:()=>gs,ArrowKind:()=>Bi,AssertionExpression:()=>Ts,AssertionKind:()=>Zr,AtomicRMWOp:()=>Uu,BinaryExpression:()=>bs,BinaryModule:()=>Eo,BinaryOp:()=>oi,BlockStatement:()=>Qs,BrOnOp:()=>t_,BreakStatement:()=>Zs,CallExpression:()=>Is,Class:()=>$r,ClassDeclaration:()=>Mi,ClassExpression:()=>vs,ClassPrototype:()=>An,CommaExpression:()=>xs,CommentKind:()=>Do,CommentNode:()=>ys,CommonFlags:()=>Me,CommonNames:()=>w,CompiledExpression:()=>Ks,Compiler:()=>gr,ConditionKind:()=>zl,ConstantValueKind:()=>Zl,Constraints:()=>ru,ConstructorExpression:()=>Ss,ContinueStatement:()=>js,DEFAULT_STACK_SIZE:()=>SS,DeclarationStatement:()=>Ge,DeclaredElement:()=>vt,DecoratorFlags:()=>j,DecoratorKind:()=>Tt,DecoratorNode:()=>Es,DiagnosticCategory:()=>cs,DiagnosticCode:()=>nt,DiagnosticEmitter:()=>Ue,DiagnosticMessage:()=>Xr,DoStatement:()=>Js,Element:()=>vn,ElementAccessExpression:()=>Rs,ElementKind:()=>J,EmptyStatement:()=>$s,Enum:()=>Xa,EnumDeclaration:()=>ea,EnumValue:()=>Ka,EnumValueDeclaration:()=>ta,ExportDefaultStatement:()=>sa,ExportImportStatement:()=>ra,ExportMember:()=>ia,ExportNames:()=>Fn,ExportStatement:()=>na,Expression:()=>_e,ExpressionId:()=>cr,ExpressionRunnerFlags:()=>po,ExpressionStatement:()=>aa,ExternalKind:()=>eu,FEATURE_BULK_MEMORY:()=>FS,FEATURE_EXCEPTION_HANDLING:()=>OS,FEATURE_EXTENDED_CONST:()=>zS,FEATURE_FUNCTION_REFERENCES:()=>GS,FEATURE_GC:()=>BS,FEATURE_MEMORY64:()=>DS,FEATURE_MULTI_VALUE:()=>US,FEATURE_MUTABLE_GLOBALS:()=>LS,FEATURE_NONTRAPPING_F2I:()=>CS,FEATURE_REFERENCE_TYPES:()=>MS,FEATURE_RELAXED_SIMD:()=>VS,FEATURE_SIGN_EXTENSION:()=>NS,FEATURE_SIMD:()=>kS,FEATURE_TAIL_CALLS:()=>wS,FEATURE_THREADS:()=>PS,FalseExpression:()=>Ys,Feature:()=>Ut,FeatureFlags:()=>nu,Field:()=>zi,FieldDeclaration:()=>oa,FieldFlags:()=>Vl,FieldPrototype:()=>qa,File:()=>Sn,FloatLiteralExpression:()=>As,Flow:()=>Pe,FlowFlags:()=>za,ForOfStatement:()=>ua,ForStatement:()=>la,Function:()=>Xe,FunctionDeclaration:()=>ur,FunctionExpression:()=>Ns,FunctionPrototype:()=>We,FunctionTypeNode:()=>hs,GETTER_PREFIX:()=>ns,Global:()=>dr,INDEX_SUFFIX:()=>Ce,INNER_DELIMITER:()=>Fo,INSTANCE_DELIMITER:()=>Ci,IdentifierExpression:()=>$e,IdentifierHandling:()=>Vo,IfStatement:()=>pa,ImportDeclaration:()=>ca,ImportStatement:()=>Ui,IndexSignature:()=>Yi,IndexSignatureNode:()=>qs,InstanceOfExpression:()=>Ls,IntegerLiteralExpression:()=>Cs,Interface:()=>Hi,InterfaceDeclaration:()=>_a,InterfacePrototype:()=>Qa,JSBuilder:()=>er,LIBRARY_PREFIX:()=>Je,LIBRARY_SUBST:()=>as,LiteralExpression:()=>at,LiteralKind:()=>De,Local:()=>Oe,LocalFlags:()=>Wa,MemorySegment:()=>_i,MethodDeclaration:()=>fa,Module:()=>tt,ModuleDeclaration:()=>Ta,NamedTypeNode:()=>Oi,Namespace:()=>Rn,NamespaceDeclaration:()=>ha,NewExpression:()=>Fs,Node:()=>O,NodeKind:()=>gt,NullExpression:()=>ks,ObjectLiteralExpression:()=>Ps,OmittedExpression:()=>Os,OperatorKind:()=>Fe,Options:()=>kn,PARENT_SUBST:()=>Jd,PATH_DELIMITER:()=>je,Parameter:()=>Ql,ParameterKind:()=>Qr,ParameterNode:()=>ds,ParenthesizedExpression:()=>ws,Parser:()=>bn,Precedence:()=>he,Program:()=>In,Property:()=>Wi,PropertyAccessExpression:()=>Ms,PropertyPrototype:()=>Er,Range:()=>se,RefAsOp:()=>e_,RefIsOp:()=>uo,RegexpLiteralExpression:()=>Us,Relooper:()=>gi,ReportMode:()=>Aa,Resolver:()=>Vi,ReturnStatement:()=>ma,Runtime:()=>is,RuntimeFeatures:()=>iu,SETTER_PREFIX:()=>ss,SIMDExtractOp:()=>Bu,SIMDLoadOp:()=>Vu,SIMDLoadStoreLaneOp:()=>zu,SIMDReplaceOp:()=>Du,SIMDShiftOp:()=>Gu,SIMDTernaryOp:()=>Wu,STATIC_DELIMITER:()=>Fi,STUB_DELIMITER:()=>ko,SideEffects:()=>On,Signature:()=>ge,Source:()=>lr,SourceKind:()=>jr,State:()=>Ra,Statement:()=>ue,StringLiteralExpression:()=>Ds,SuperExpression:()=>Gs,SwitchBuilder:()=>Pn,SwitchCase:()=>da,SwitchStatement:()=>Ea,TSDBuilder:()=>tr,Target:()=>Wr,TemplateLiteralExpression:()=>Vs,TernaryExpression:()=>Bs,ThisExpression:()=>zs,ThrowStatement:()=>ya,Token:()=>Jr,Tokenizer:()=>Gi,TrueExpression:()=>Ws,TryStatement:()=>ga,Type:()=>u,TypeDeclaration:()=>ba,TypeDefinition:()=>ct,TypeFlags:()=>Bt,TypeKind:()=>or,TypeName:()=>fs,TypeNode:()=>Pi,TypeParameterNode:()=>ms,TypeRef:()=>F,TypedElement:()=>xt,Typeinfo:()=>Yr,TypeinfoFlags:()=>Li,UnaryExpression:()=>wi,UnaryOp:()=>mn,UnaryPostfixExpression:()=>Hs,UnaryPrefixExpression:()=>Xs,VariableDeclaration:()=>Ia,VariableLikeDeclarationStatement:()=>qr,VariableLikeElement:()=>Wt,VariableStatement:()=>va,VoidStatement:()=>xa,WhileStatement:()=>Sa,addGlobalAlias:()=>gS,allocPtrArray:()=>me,buildJS:()=>mR,buildTSD:()=>hR,compile:()=>fR,createType:()=>Be,diagnosticCategoryToColor:()=>np,diagnosticCategoryToString:()=>ps,diagnosticCodeToString:()=>ts,disableFeature:()=>YS,enableFeature:()=>WS,expandType:()=>tu,featureToString:()=>zr,findDecorator:()=>bt,findUsedLocals:()=>lt,formatDiagnostic:()=>sp,formatDiagnosticMessage:()=>sp,getBinaryLeft:()=>Ve,getBinaryOp:()=>ai,getBinaryRight:()=>Re,getBinaryenModuleRef:()=>dR,getBlockChildAt:()=>gn,getBlockChildCount:()=>yn,getBlockName:()=>En,getBreakCondition:()=>O2,getBreakName:()=>P2,getCallOperandAt:()=>ke,getCallOperandCount:()=>ut,getCallTarget:()=>hn,getConstValueF32:()=>Ke,getConstValueF64:()=>qe,getConstValueI32:()=>ie,getConstValueI64High:()=>rt,getConstValueI64Low:()=>ze,getConstValueV128:()=>su,getDefaultParameterName:()=>kc,getDependee:()=>cR,getDiagnosticCategory:()=>JS,getDiagnosticCode:()=>jS,getDiagnosticMessage:()=>$S,getDiagnosticRange:()=>eR,getDiagnosticRelatedRange:()=>tR,getDropValue:()=>M2,getExpressionId:()=>te,getExpressionType:()=>oe,getFunctionBody:()=>D2,getFunctionName:()=>G2,getFunctionParams:()=>V2,getFunctionResults:()=>z2,getFunctionVars:()=>W2,getGlobalGetName:()=>dn,getGlobalInit:()=>X2,getGlobalName:()=>Y2,getGlobalType:()=>H2,getIfCondition:()=>Va,getIfFalse:()=>si,getIfTrue:()=>fn,getLoadBytes:()=>Wl,getLoadOffset:()=>S2,getLoadPtr:()=>R2,getLocalGetIndex:()=>pt,getLocalSetIndex:()=>Da,getLocalSetValue:()=>mr,getLoopBody:()=>k2,getLoopName:()=>F2,getMemoryGrowDelta:()=>B2,getRangeEnd:()=>iR,getRangeSource:()=>nR,getRangeStart:()=>rR,getReturnValue:()=>U2,getSelectCondition:()=>w2,getSelectElse:()=>Xl,getSelectThen:()=>Hl,getSideEffects:()=>fi,getSource:()=>ZS,getSourceNormalizedPath:()=>sR,getStoreBytes:()=>A2,getStoreOffset:()=>N2,getStorePtr:()=>L2,getStoreValue:()=>C2,getTagName:()=>K2,getTagParams:()=>q2,getTagResults:()=>Q2,getUnaryOp:()=>_n,getUnaryValue:()=>Ga,initializeProgram:()=>_R,isConstNonZero:()=>et,isConstZero:()=>be,isDeclaredElement:()=>xn,isError:()=>lR,isGlobalMutable:()=>au,isIllegalVariableIdentifier:()=>zo,isInfo:()=>aR,isLoadSigned:()=>Yl,isLocalTee:()=>cn,isTypeOmitted:()=>Se,isTypedElement:()=>Wo,isWarning:()=>oR,mangleInternalName:()=>Ie,mangleInternalPath:()=>Di,mustPreserveSideEffects:()=>ho,needsExplicitUnreachable:()=>co,newOptions:()=>sS,newProgram:()=>qS,nextDiagnostic:()=>QS,nextFile:()=>pR,operatorTokenToString:()=>Te,optimize:()=>yR,parse:()=>uR,readString:()=>He,removeGlobalAlias:()=>TS,setBasenameHint:()=>XS,setBundleVersion:()=>AS,setExportMemory:()=>uS,setExportRuntime:()=>xS,setExportStart:()=>bS,setExportTable:()=>mS,setImportMemory:()=>pS,setImportTable:()=>hS,setInitialMemory:()=>cS,setLowMemoryLimit:()=>vS,setMaximumMemory:()=>_S,setMemoryBase:()=>ES,setNoAssert:()=>lS,setNoUnsafe:()=>IS,setOptimizeLevelHints:()=>HS,setPedantic:()=>KS,setRuntime:()=>oS,setSharedMemory:()=>fS,setSourceMap:()=>dS,setStackSize:()=>RS,setTableBase:()=>yS,setTarget:()=>aS,tokenFromKeyword:()=>ap,tokenIsAlsoIdentifier:()=>op,typesToRefs:()=>Kr,typesToString:()=>_s,util:()=>Bo,validate:()=>ER});var Q=typeof window<"u"&&window||typeof global<"u"&&global||self;if(typeof Q.ASC_TARGET>"u"){let t=function(){Error.captureStackTrace?Error.captureStackTrace(this,t):this.stack=this.name+": "+this.message+`
...
`),z(s,--this.indentLevel),s.push("}")),s.push(`,
`)}makeFunctionImport(e,r,i,s=null){var a=this.sb,o=i.signature;if(z(a,this.indentLevel),we(r)?a.push(r):(a.push('"'),a.push(de(r,34)),a.push('"')),Xu(o,kt.IMPORT)&&!s)a.push(`: (
...
`);for(let f=0,d=l.length;f<d;++f){let y=l[f];if(!wr(y,kt.EXPORT)){let b=i.getParameterName(f);z(a,this.indentLevel),a.push(b),a.push(" = "),this.makeLiftFromValue(b,y,a),a.push(`;
`)}}let c=new Array,_=this.ensureModuleId(e);s?(c.push(`(() => {
`),z(c,1),c.push(`// @external.js
`),qh(s,1,c),c.push(`
})()`)):(e!="env"&&(c.push("__module"),c.push(_.toString()),c.push(".")),c.push(r),c.push("("),c.push(p.join(", ")),c.push(")")),s=c.join(""),c.length=0,qh(s,this.indentLevel,c,!0),s=c.join(""),z(a,this.indentLevel),o.returnType!=u.void?(a.push("return "),this.makeLowerToValue(s,o.returnType,a),a.push(`;
`)):(a.push(s),a.push(`;
`)),z(a,--this.indentLevel),a.push("}")}a.push(`,
`)}visitFunction(e,r){if(!r.is(512)){var i=this.sb,s=r.signature;if(this.exports.push(e),!Xu(s,kt.EXPORT)){z(i,this.indentLevel),i.push(e),i.push("(");let a=s.parameterTypes,o=0;for(let c=0,_=a.length;c<_;++c)a[c].isInternalReference&&o++,c>0&&i.push(", "),i.push(r.getParameterName(c));i.push(`) {
...
`)):a.length=l-2;var c=this.importMappings,_=new Array;for(let b=Map_keys(c),v=0,I=b.length;v<I;++v){let S=b[v];if(S=="env")_.push(`  const env = imports.env;
...
`)):this.needsLiftBuffer||this.needsLowerBuffer||this.needsLiftString||this.needsLowerString||this.needsLiftArray||this.needsLowerArray||this.needsLiftTypedArray||this.needsLowerTypedArray||this.needsLiftStaticArray?a.length=l-2:a.length=l-4;var d=this.deferredCode;if(d.length)for(let b=0,v=d.length;b<v;++b)a.push(d[b]);if(this.needsLiftBuffer){let b=i.OBJECTInstance,v=b.offsetof("rtSize")-b.nextMemoryOffset;a.push(`  function __liftBuffer(pointer) {
...
`)}if(this.needsLiftString){let b=i.OBJECTInstance,v=b.offsetof("rtSize")-b.nextMemoryOffset,I=1024;a.push(`  function __liftString(pointer) {
    if (!pointer) return null;
    const
...
`)}if(this.needsLiftArray){let b=i.arrayBufferViewInstance.offsetof("dataStart"),v=i.arrayBufferViewInstance.nextMemoryOffset;a.push(`  function __liftArray(liftElement, align, pointer) {
    if (!pointer) return null;
    const
...
`)}if(this.needsLowerArray){let b=i.arrayBufferInstance.id,v=i.arrayBufferViewInstance,I=v.nextMemoryOffset+4,S=v.offsetof("buffer"),R=v.offsetof("dataStart"),A=v.offsetof("byteLength"),P=A+4;a.push(`  function __lowerArray(lowerElement, id, align, values) {
...
`)}if(this.needsLiftTypedArray){let b=i.arrayBufferViewInstance,v=b.offsetof("dataStart"),I=b.offsetof("byteLength");a.push(`  function __liftTypedArray(constructor, pointer) {
    if (!pointer) return null;
...
`)}if(this.needsLowerTypedArray){let b=i.arrayBufferInstance.id,v=i.arrayBufferViewInstance,I=v.nextMemoryOffset,S=v.offsetof("buffer"),R=v.offsetof("dataStart"),A=v.offsetof("byteLength");a.push(`  function __lowerTypedArray(constructor, id, align, values) {
    if (values == null) return 0;
    const
      length = values.length,
      buffer = exports.__pin(exports.__new(length << align, ${b})) >>> 0,
...
`)}if(this.needsLiftStaticArray){let b=i.OBJECTInstance,v=b.offsetof("rtSize")-b.nextMemoryOffset;a.push(`  function __liftStaticArray(liftElement, align, pointer) {
    if (!pointer) return null;
    const
...
`);let b=!1,v=new Array;for(let I=Map_keys(c),S=0,R=I.length;S<R;++S){let A=I[S];if(A=="env")z(a,2),a.push(`env: globalThis,
...
`),z(r,--this.indentLevel),r.push(`}
`),r.join("")}},kt=(e=>(e[e.IMPORT=0]="IMPORT",e[e.EXPORT=1]="EXPORT",e))(kt||{});function wr(t,n){if(n==0){if(t.isIntegerValue&&t.size==64||t==u.bool)return!1}else if(t.isUnsignedIntegerValue&&t.size==32||t==u.bool)return!1;return!t.isInternalReference}function Xu(t,n){var e=t.parameterTypes,r=n==0?1:0;for(let i=0,s=e.length;i<s;++i)if(!wr(e[i],r))return!1;return!!wr(t.returnType,n)}function qh(t,n,e,r=!1){for(var i=0,s=t.length,a=0;a<s;)t.charCodeAt(a)==10&&(r?r=!1:z(e,n),e.push(t.substring(i,i=a+1))),++a;i<s&&(r||z(e,n),e.push(t.substring(i)))}var tr=class extends bi{constructor(e,r,i=!1){super(e,i);this.sb=[];this.indentLevel=0;this.seenObjectTypes=new Map;this.deferredTypings=new Array;this.esm=r}static build(e,r=!0){return new tr(e,r).build()}visitGlobal(e,r){var i=this.sb,s=r.type,a=this.toTypeScriptType(s,Ii.EXPORT);z(i,this.indentLevel),i.push("/** "),i.push(r.internalName),i.push(` */
...
`)}else e.push(`
`);z(e,this.indentLevel)}serializeParameter(n){var e=this.sb,r=n.parameterKind,i=n.implicitFieldDeclaration;i&&this.serializeAccessModifiers(i),r==2&&e.push("..."),this.visitIdentifierExpression(n.name);var s=n.type,a=n.initializer;s&&(r==1&&!a&&e.push("?"),Se(s)||(e.push(": "),this.visitTypeNode(s))),a&&(e.push(" = "),this.visitNode(a))}serializeExternalModifiers(n){var e=this.sb;n.is(2)?e.push("export "):n.is(1)?e.push("import "):n.is(4)&&e.push("declare ")}serializeAccessModifiers(n){var e=this.sb;n.is(4)&&e.push("declare "),n.is(256)?e.push("public "):n.is(512)?e.push("private "):n.is(1024)&&e.push("protected "),n.is(32)?e.push("static "):n.is(128)&&e.push("abstract "),n.is(64)&&e.push("readonly ")}finish(){var n=this.sb.join("");return this.sb=[],n}};var fV=Ku;export{es as ASTBuilder,gs as ArrayLiteralExpression,Bi as ArrowKind,Ts as AssertionExpression,Zr as AssertionKind,Uu as AtomicRMWOp,bs as BinaryExpression,Eo as BinaryModule,oi as BinaryOp,Qs as BlockStatement,t_ as BrOnOp,Zs as BreakStatement,Is as CallExpression,$r as Class,Mi as ClassDeclaration,vs as ClassExpression,An as ClassPrototype,xs as CommaExpression,Do as CommentKind,ys as CommentNode,Me as CommonFlags,w as CommonNames,Ks as CompiledExpression,gr as Compiler,zl as ConditionKind,Zl as ConstantValueKind,ru as Constraints,Ss as ConstructorExpression,js as ContinueStatement,SS as DEFAULT_STACK_SIZE,Ge as DeclarationStatement,vt as DeclaredElement,j as DecoratorFlags,Tt as DecoratorKind,Es as DecoratorNode,cs as DiagnosticCategory,nt as DiagnosticCode,Ue as DiagnosticEmitter,Xr as DiagnosticMessage,Js as DoStatement,vn as Element,Rs as ElementAccessExpression,J as ElementKind,$s as EmptyStatement,Xa as Enum,ea as EnumDeclaration,Ka as EnumValue,ta as EnumValueDeclaration,sa as ExportDefaultStatement,ra as ExportImportStatement,ia as ExportMember,Fn as ExportNames,na as ExportStatement,_e as Expression,cr as ExpressionId,po as ExpressionRunnerFlags,aa as ExpressionStatement,eu as ExternalKind,FS as FEATURE_BULK_MEMORY,OS as FEATURE_EXCEPTION_HANDLING,zS as FEATURE_EXTENDED_CONST,GS as FEATURE_FUNCTION_REFERENCES,BS as FEATURE_GC,DS as FEATURE_MEMORY64,US as FEATURE_MULTI_VALUE,LS as FEATURE_MUTABLE_GLOBALS,CS as FEATURE_NONTRAPPING_F2I,MS as FEATURE_REFERENCE_TYPES,VS as FEATURE_RELAXED_SIMD,NS as FEATURE_SIGN_EXTENSION,kS as FEATURE_SIMD,wS as FEATURE_TAIL_CALLS,PS as FEATURE_THREADS,Ys as FalseExpression,Ut as Feature,nu as FeatureFlags,zi as Field,oa as FieldDeclaration,Vl as FieldFlags,qa as FieldPrototype,Sn as File,As as FloatLiteralExpression,Pe as Flow,za as FlowFlags,ua as ForOfStatement,la as ForStatement,Xe as Function,ur as FunctionDeclaration,Ns as FunctionExpression,We as FunctionPrototype,hs as FunctionTypeNode,ns as GETTER_PREFIX,dr as Global,Ce as INDEX_SUFFIX,Fo as INNER_DELIMITER,Ci as INSTANCE_DELIMITER,$e as IdentifierExpression,Vo as IdentifierHandling,pa as IfStatement,ca as ImportDeclaration,Ui as ImportStatement,Yi as IndexSignature,qs as IndexSignatureNode,Ls as InstanceOfExpression,Cs as IntegerLiteralExpression,Hi as Interface,_a as InterfaceDeclaration,Qa as InterfacePrototype,er as JSBuilder,Je as LIBRARY_PREFIX,as as LIBRARY_SUBST,at as LiteralExpression,De as LiteralKind,Oe as Local,Wa as LocalFlags,_i as MemorySegment,fa as MethodDeclaration,tt as Module,Ta as ModuleDeclaration,Oi as NamedTypeNode,Rn as Namespace,ha as NamespaceDeclaration,Fs as NewExpression,O as Node,gt as NodeKind,ks as NullExpression,Ps as ObjectLiteralExpression,Os as OmittedExpression,Fe as OperatorKind,kn as Options,Jd as PARENT_SUBST,je as PATH_DELIMITER,Ql as Parameter,Qr as ParameterKind,ds as ParameterNode,ws as ParenthesizedExpression,bn as Parser,he as Precedence,In as Program,Wi as Property,Ms as PropertyAccessExpression,Er as PropertyPrototype,se as Range,e_ as RefAsOp,uo as RefIsOp,Us as RegexpLiteralExpression,gi as Relooper,Aa as ReportMode,Vi as Resolver,ma as ReturnStatement,is as Runtime,iu as RuntimeFeatures,ss as SETTER_PREFIX,Bu as SIMDExtractOp,Vu as SIMDLoadOp,zu as SIMDLoadStoreLaneOp,Du as SIMDReplaceOp,Gu as SIMDShiftOp,Wu as SIMDTernaryOp,Fi as STATIC_DELIMITER,ko as STUB_DELIMITER,On as SideEffects,ge as Signature,lr as Source,jr as SourceKind,Ra as State,ue as Statement,Ds as StringLiteralExpression,Gs as SuperExpression,Pn as SwitchBuilder,da as SwitchCase,Ea as SwitchStatement,tr as TSDBuilder,Wr as Target,Vs as TemplateLiteralExpression,Bs as TernaryExpression,zs as ThisExpression,ya as ThrowStatement,Jr as Token,Gi as Tokenizer,Ws as TrueExpression,ga as TryStatement,u as Type,ba as TypeDeclaration,ct as TypeDefinition,Bt as TypeFlags,or as TypeKind,fs as TypeName,Pi as TypeNode,ms as TypeParameterNode,F as TypeRef,xt as TypedElement,Yr as Typeinfo,Li as TypeinfoFlags,wi as UnaryExpression,mn as UnaryOp,Hs as UnaryPostfixExpression,Xs as UnaryPrefixExpression,Ia as VariableDeclaration,qr as VariableLikeDeclarationStatement,Wt as VariableLikeElement,va as VariableStatement,xa as VoidStatement,Sa as WhileStatement,gS as addGlobalAlias,me as allocPtrArray,mR as buildJS,hR as buildTSD,fR as compile,Be as createType,fV as default,np as diagnosticCategoryToColor,ps as diagnosticCategoryToString,ts as diagnosticCodeToString,YS as disableFeature,WS as enableFeature,tu as expandType,zr as featureToString,bt as findDecorator,lt as findUsedLocals,sp as formatDiagnostic,sp as formatDiagnosticMessage,Ve as getBinaryLeft,ai as getBinaryOp,Re as getBinaryRight,dR as getBinaryenModuleRef,gn as getBlockChildAt,yn as getBlockChildCount,En as getBlockName,O2 as getBreakCondition,P2 as getBreakName,ke as getCallOperandAt,ut as getCallOperandCount,hn as getCallTarget,Ke as getConstValueF32,qe as getConstValueF64,ie as getConstValueI32,rt as getConstValueI64High,ze as getConstValueI64Low,su as getConstValueV128,kc as getDefaultParameterName,cR as getDependee,JS as getDiagnosticCategory,jS as getDiagnosticCode,$S as getDiagnosticMessage,eR as getDiagnosticRange,tR as getDiagnosticRelatedRange,M2 as getDropValue,te as getExpressionId,oe as getExpressionType,D2 as getFunctionBody,G2 as getFunctionName,V2 as getFunctionParams,z2 as getFunctionResults,W2 as getFunctionVars,dn as getGlobalGetName,X2 as getGlobalInit,Y2 as getGlobalName,H2 as getGlobalType,Va as getIfCondition,si as getIfFalse,fn as getIfTrue,Wl as getLoadBytes,S2 as getLoadOffset,R2 as getLoadPtr,pt as getLocalGetIndex,Da as getLocalSetIndex,mr as getLocalSetValue,k2 as getLoopBody,F2 as getLoopName,B2 as getMemoryGrowDelta,iR as getRangeEnd,nR as getRangeSource,rR as getRangeStart,U2 as getReturnValue,w2 as getSelectCondition,Xl as getSelectElse,Hl as getSelectThen,fi as getSideEffects,ZS as getSource,sR as getSourceNormalizedPath,A2 as getStoreBytes,N2 as getStoreOffset,L2 as getStorePtr,C2 as getStoreValue,K2 as getTagName,q2 as getTagParams,Q2 as getTagResults,_n as getUnaryOp,Ga as getUnaryValue,_R as initializeProgram,et as isConstNonZero,be as isConstZero,xn as isDeclaredElement,lR as isError,au as isGlobalMutable,zo as isIllegalVariableIdentifier,aR as isInfo,Yl as isLoadSigned,cn as isLocalTee,Se as isTypeOmitted,Wo as isTypedElement,oR as isWarning,Ie as mangleInternalName,Di as mangleInternalPath,ho as mustPreserveSideEffects,co as needsExplicitUnreachable,sS as newOptions,qS as newProgram,QS as nextDiagnostic,pR as nextFile,Te as operatorTokenToString,yR as optimize,uR as parse,He as readString,TS as removeGlobalAlias,XS as setBasenameHint,AS as setBundleVersion,uS as setExportMemory,xS as setExportRuntime,bS as setExportStart,mS as setExportTable,pS as setImportMemory,hS as setImportTable,cS as setInitialMemory,vS as setLowMemoryLimit,_S as setMaximumMemory,ES as setMemoryBase,lS as setNoAssert,IS as setNoUnsafe,HS as setOptimizeLevelHints,KS as setPedantic,oS as setRuntime,fS as setSharedMemory,dS as setSourceMap,RS as setStackSize,yS as setTableBase,aS as setTarget,ap as tokenFromKeyword,op as tokenIsAlsoIdentifier,Kr as typesToRefs,_s as typesToString,Bo as util,ER as validate};
